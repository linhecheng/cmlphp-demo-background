...
abstract class BuilderBase
{
    ...
    public function display($layout = 'regional', $layoutInOtherApp = 'adminbase')
    {
        ...
        View::getEngine('Html')->setHtmlEngineOptions('templateDir', dirname(__DIR__) . DIRECTORY_SEPARATOR . 'View' . DIRECTORY_SEPARATOR)
            ->assign('layerWidthHeight', $this->layerWidthHeight)
            ->assign('appendFooter', $this->appendFooter);
    }
